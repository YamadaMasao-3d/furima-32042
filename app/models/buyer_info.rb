class BuyerInfo
  ...
  attr_accessor :postal_code, :prefecture_id, :municipality, :address, :building_name, :phone_number, :token, :user, :item
  ...
  def save
  purchase_history = PurchaseHistory.create(user_id: user.id, item_id: item.id)
